...
---
### 🚀 Mes projets - La Plateforme
---

### 🎓 2 ème année - Licence d'Administrateur d'Infrastructure Réseaux Sécurisés

- [**🔷Terraform**](https://github.com/leon-camuzat/Terraform.git) *: Automatisation du déploiement d'une VM Debian 13 sur VMWare Wrokstation et déploiement d'un lab cyber avec une VM attaquante et une VM hébergeant un serveur Web.*
...
- [**☁️Azure AD**](https://github.com/leon-camuzat/Azure_AD.git)  *: Documentation technique sur Azure.*

- [**☁️AWS**](https://github.com/leon-camuzat/AWS_-_Azure)  *: Documentation technique sur AWS.*

  ---

### 🎓 1ère année - Licence d'Administrateur d'Infrastructure Réseaux Sécurisés
...
- [**🖥️Dual-Boot Windows/Linux**](https://github.com/leon-camuzat/Dual_Boot)  *: Configuration d'un dual-boot Windows/Linux via VMware Workstation Pro.*
