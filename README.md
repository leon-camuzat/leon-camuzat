...
Passionné de Cybersécurité et de Linux je suis étudiant en 3ème année Licence d'Administrateur d'Infrastructures Sécurisées (AIS) à [La Plateforme](https://laplateforme.io) et alternant sécurité du SI à la DSI **Ville de Marseille** au sein de l'équipe sécurité je suis passionné de cybersécurité et de Linux.
